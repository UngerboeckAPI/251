...
namespace Examples.Operations
{
  public class EventOpportunities : Base
  {
    ...
    /// <summary>
    /// Simple add example. Use this method only to add rank, businesstype, leadSource, bidDue to the model along with basic fields.
    /// </summary>
    /// <returns>Added EventOpportunitiesModel</returns>
    public EventOpportunitiesModel Add(string rank, int businessType, string leadSource, DateTime? bidDue)
    {
      var eventOpportunitiesModel = new EventOpportunitiesModel
      {
        Description = "UPI Test Meeting",
