...
namespace Ungerboeck.Api.Sdk
{
  public class EndpointCollection
  {
    ...
    private BookingRoleAccounts BookingRoleAccountsApi;
    public BookingRoleAccounts BookingRoleAccounts
    {
      get
      {
        if (BookingRoleAccountsApi == null) BookingRoleAccountsApi = new BookingRoleAccounts(client);
        return BookingRoleAccountsApi;
      }
    }

    private BookingRoleContacts BookingRoleContactsApi;
    public BookingRoleContacts BookingRoleContacts
    {
      get
      {
        if (BookingRoleContactsApi == null) BookingRoleContactsApi = new BookingRoleContacts(client);
        return BookingRoleContactsApi;
      }
    }

    private BookingRoleTypes BookingRoleTypesApi;
    public BookingRoleTypes BookingRoleTypes
    {
      get
      {
        if (BookingRoleTypesApi == null) BookingRoleTypesApi = new BookingRoleTypes(client);
        return BookingRoleTypesApi;
      }
    }
    ...
    private BookingRoles BookingRolesApi;
    public BookingRoles BookingRoles
    {
      get
      {
        if (BookingRolesApi == null) BookingRolesApi = new BookingRoles(client);
        return BookingRolesApi;
      }
    }
    ...
    private BookingRoleOsbConfigurations BookingRoleOsbConfigurationsApi;
    public  BookingRoleOsbConfigurations BookingRoleOsbConfigurations
    {
      get
      {
        if (BookingRoleOsbConfigurationsApi == null) BookingRoleOsbConfigurationsApi = new BookingRoleOsbConfigurations(client);
        return BookingRoleOsbConfigurationsApi;
      }
    }
    ...
    private EventOpportunityContacts EventOpportunityContactsApi;
    public EventOpportunityContacts EventOpportunityContacts
    {
      get
      {
        if (EventOpportunityContactsApi == null) EventOpportunityContactsApi = new EventOpportunityContacts(client);
        return EventOpportunityContactsApi;
      }
    }
    ...
    private EventOpportunityDates EventOpportunityDatesApi;
    public EventOpportunityDates EventOpportunityDates
    {
      get
      {
        if (EventOpportunityDatesApi == null) EventOpportunityDatesApi = new EventOpportunityDates(client);
        return EventOpportunityDatesApi;
      }
    }
    ...
    private EventHousingBlocks EventHousingBlocksApi;
    public EventHousingBlocks EventHousingBlocks
    {
      get
      {
        if (EventHousingBlocksApi == null) EventHousingBlocksApi = new EventHousingBlocks(client);
        return EventHousingBlocksApi;
      }
    }
    ...
    private RoomFlowInventories RoomFlowInventoriesApi;
    public RoomFlowInventories RoomFlowInventories
    {
      get
      {
        if (RoomFlowInventoriesApi == null) RoomFlowInventoriesApi = new RoomFlowInventories(client);
        return RoomFlowInventoriesApi;
      }
    }
    ...
    private GroupPropertyConfigurations GroupPropertyConfigurationsApi;
    public GroupPropertyConfigurations GroupPropertyConfigurations
    {
      get
      {
        if (GroupPropertyConfigurationsApi == null) GroupPropertyConfigurationsApi = new GroupPropertyConfigurations(client);
        return GroupPropertyConfigurationsApi;
      }
    }
    ...
    private SpaceClasses SpaceClassesApi;
    public SpaceClasses SpaceClasses
    {
      get
      {
        if (SpaceClassesApi == null) SpaceClassesApi = new SpaceClasses(client);
        return SpaceClassesApi;
      }
    }
